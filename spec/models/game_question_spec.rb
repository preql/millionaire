...
RSpec.describe GameQuestion, type: :model do
  ...
  context 'game status' do
    ...
    it 'correct .help_hash' do
      ...
      game_question.help_hash[:some_key1] = ['a','c']
      game_question.help_hash['some_key2'] = { 'a' => 35, 'b' => 43 }
      game_question.help_hash[:some_key3] = 'Answer correct'
      ...
      expect(gq.help_hash).to eq({some_key1: ['a', 'c'], 'some_key2' => {'a' => 35, 'b' => 43}, some_key3: 'Answer correct'})
    end
  end
